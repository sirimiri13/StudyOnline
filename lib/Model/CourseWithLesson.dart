...
CourseWithLesson courseWithLessonFromJson(String str) => CourseWithLesson.fromJson(json.decode(str));

String courseWithLessonToJson(CourseWithLesson data) => json.encode(data.toJson());

class CourseWithLesson {
  CourseWithLesson({
    this.id,
    this.title,
    this.subtitle,
  ...
  factory CourseWithLesson.fromJson(Map<String, dynamic> json) => CourseWithLesson(
    id: json["id"],
    title: json["title"],
